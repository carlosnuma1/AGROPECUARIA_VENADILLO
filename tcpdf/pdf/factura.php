...
$bloque1 = <<<EOF
	...
	<table>
		...
		<tr>
			...
			<td style="width:150px"><img src="images/logotipo.jpg" style="width:80px,height:80px"></td>
...
$bloque3 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<td style="border: 1px solid #666; background-color:white; width:260px; text-align:center">REPUESTO</td>
		<td style="border: 1px solid #666; background-color:white; width:80px; text-align:center">CANTIDAD</td>
		<td style="border: 1px solid #666; background-color:white; width:100px; text-align:center">PRECIO N.</td>
